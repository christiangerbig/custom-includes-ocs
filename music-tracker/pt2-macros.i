...
pt_RtnChkAllChannels
		...
		beq.s	pt_NoRtnSetTimer ; No -> skip
...
pt_StpNoFinetune
		...
		move.b	#1,n_toneportdirec(a2) ; If wanted note period < note period -> Set to new portamento direction = 1
pt_StpEnd
		rts
		CNOP 0,4
pt_ClearTonePorta
...
pt_ArpeggioFind
	...
	IFEQ pt_finetune_enabled
		moveq	#0,d7 		; Needed for word access
